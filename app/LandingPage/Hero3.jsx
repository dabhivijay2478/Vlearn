        ...
        <>
            ...
            >
                ...
                <motion.section
                    ...
                    className="w-full py-2 px-2 md:py-20 lg:py-20" id="pricing">
                    <motion.div
                    ...
                    >
                        <div className="flex flex-col items-center text-center gap-4">
                            ...
                            <p className="max-w-xl text-gray-500 dark:text-gray-400">
                                Choose the plan that best suits your needs and start your coding journey with V learn.
                            </p>
                        </div>
                    </motion.div>
                    <motion.div
                        className="mt-2 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-0 mr-16"
                        variants={itemVariants}
                        initial="hidden"
                        animate="visible"
                    >
                            ...
                            <CardBody className="bg-slate-900 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                                <motion.div variants={itemVariants}>
                                    ...
                                    <div className="flex justify-between items-center mt-20">
                                        <Link className="inline-flex h-10 items-center justify-center rounded-md bg-cyan-700 px-6 text-sm font-medium text-gray-950 transition-colors hover:bg-purple-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950" href="#">
                                            <CardItem translateZ={20} as="button" className="px-4 py-2 rounded-xl dark:text-black text-white text-xs font-bold">
                                                Get Started
                                            </CardItem>
                                        </Link>
                                    </div>
