...
export default function ResourcesSideBar() {
    ...
    return (
        <>
            <div className="hidden md:block   border-gray-200 dark:border-gray-800 w-64 p-6 overflow-y-auto space-y-3">
                ...
                <ScrollArea className="h-96  rounded-md border border-purple-500">
